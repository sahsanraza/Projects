...
public class MentionsActivity  extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.mentions_activity);
	...
	//Method to get mentions tweets and place them in listview
	public void getTweets()
	{
		...
		//Collect correct content for each tweet.
		...
		protected Long doInBackground(String... s)
		{
			...
			try 
			{
				if (m.verifyCredential()) 
				{
					...
					//Get mentions tweets for bji6_ben twitter account
					Timeline tml = Timeline.getInstance(m);
					
					tml.startGetMentions(null, ml);
